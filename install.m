...
mex COMPFLAGS="$COMPFLAGS /openmp" CFLAGS='$CFLAGS -fopenmp' -LDFLAGS='$LDFLAGS -fopenmp' COPTIMFLAGS="-O3 -fwrapv -DNDEBUG" ./cpp/cevstreamline.cpp;
...
mex COMPFLAGS="$COMPFLAGS /openmp" CFLAGS='$CFLAGS -fopenmp' -LDFLAGS='$LDFLAGS -fopenmp' COPTIMFLAGS="-O3 -fwrapv -DNDEBUG" ./cpp/cflowmap.cpp;
